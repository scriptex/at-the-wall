...
<body>
		...
		<nav class="socials">
			<ul>
				<li>
					...
					>
						<svg class="c-svg-logo"><use xlink:href="#svg-logo"></use></svg>
					</a>
				</li>
				<li>
					<a
					...
					>
						<svg class="c-svg-email"><use xlink:href="#svg-email"></use></svg>
					</a>
				</li>
				<li>
					<a
					...
					>
						<svg class="c-svg-linkedin"><use xlink:href="#svg-linkedin"></use></svg>
					</a>
				</li>
				<li>
					<a
					...
					>
						<svg class="c-svg-github"><use xlink:href="#svg-github"></use></svg>
					</a>
				</li>
				<li>
					<a
					...
					>
						<svg class="c-svg-gitlab"><use xlink:href="#svg-gitlab"></use></svg>
					</a>
				</li>
				<li>
					<a
					...
					>
						<svg class="c-svg-twitter"><use xlink:href="#svg-twitter"></use></svg>
					</a>
				</li>
				<li>
					<a
					...
					>
						<svg class="c-svg-npm"><use xlink:href="#svg-npm"></use></svg>
					</a>
				</li>
				<li>
					<a
						href="https://www.youtube.com/user/scriptex"
						target="_blank"
						rel="noopener noreferrer"
						title="See my videos on YouTube"
					>
						<svg class="c-svg-youtube"><use xlink:href="#svg-youtube"></use></svg>
					</a>
				</li>
				<li>
					<a
						href="https://stackoverflow.com/users/4140082/atanas-atanasov"
						target="_blank"
						rel="noopener noreferrer"
						title="See my profile on StackOverflow"
					>
						<svg class="c-svg-stackoverflow"><use xlink:href="#svg-stackoverflow"></use></svg>
					</a>
				</li>
				<li>
					<a
					...
					>
						<svg class="c-svg-codepen"><use xlink:href="#svg-codepen"></use></svg>
					</a>
				</li>
				<li>
					<a
					...
					>
						<svg class="c-svg-codersrank"><use xlink:href="#svg-codersrank"></use></svg>
					</a>
				</li>
				<li>
					<a
						href="https://sourcerer.io/scriptex"
						target="_blank"
						rel="noopener noreferrer"
	...
	>
		...
		<symbol viewBox="0 0 63 41" id="svg-codersrank">
			<g fill="none" stroke="#FFF">
				<path
					fill="#19223C"
					d="M34.25 1.055L3.147 20.635c-1.465.886-2.18 1.878-2.146 2.977v2.98c.035 1.1.768 2.075 2.2 2.926l15.393 8.885a.726.726 0 001.047-.373l3.456-8.352-7.33-4.15a1.316 1.316 0 01-.697-.976 1.345 1.345 0 01.644-1.365l13.457-8.247 5.55-13.512a.324.324 0 00-.104-.36.311.311 0 00-.369-.013h.002z"
				></path>
				<path
					fill="#67A4AC"
					d="M59.8 11.962L44.618 2.758a.726.726 0 00-1.047.32l-3.56 8.352 7.225 4.31c.208.113.381.282.502.488a1.347 1.347 0 01-.502 1.853l-13.56 7.98-5.76 13.407a.323.323 0 00.131.515.311.311 0 00.34-.09l9.948-6.011 3.927 5.64a.947.947 0 00.785.425h9.425a.932.932 0 00.832-.506.97.97 0 00-.047-.984l-6.388-9.79 12.933-7.82c1.466-.887 2.2-1.88 2.2-2.98V14.94c0-1.1-.734-2.092-2.2-2.98H59.8z"
				></path>
			</g>
		</symbol>
		...
		<symbol viewBox="0 0 206 206" id="svg-logo">
		...
		<symbol viewBox="0 0 27.23 27.23" id="svg-npm">
			<path d="M5.8 21.75h7.86l.01-11.77h3.92l-.01 11.78h3.93l.01-15.7-15.7-.02-.02 15.71z"></path>
		</symbol>
		<symbol viewBox="0 0 110 118" id="svg-stackoverflow">
			<path d="M84.072 107.351V75.8h10.516v42.069H0V75.8h10.516v31.551z"></path>
			<path
				d="M22.089 72.898l51.458 10.815 2.163-10.292-51.458-10.815-2.163 10.292zm6.808-24.639l47.666 22.199 4.44-9.533-47.666-22.199-4.44 9.533zm13.191-23.385l40.405 33.65 6.73-8.081-40.405-33.65-6.73 8.081zM68.171 0l-8.438 6.276 31.381 42.191 8.438-6.276L68.171 0zM21.044 96.833h52.582V86.316H21.044v10.517z"
			></path>
		</symbol>
